...
CK_VISIBLE_PUBLIC void CkSocket_getUncommonOptions(HCkSocket cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void CkSocket_putUncommonOptions(HCkSocket cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkSocket_uncommonOptions(HCkSocket cHandle);
