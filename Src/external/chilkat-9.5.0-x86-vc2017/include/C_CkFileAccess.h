...
CK_VISIBLE_PUBLIC BOOL CkFileAccess_getLockFileOnOpen(HCkFileAccess cHandle);
CK_VISIBLE_PUBLIC void CkFileAccess_putLockFileOnOpen(HCkFileAccess cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkFileAccess_FileSizeStr(HCkFileAccess cHandle, const char *filePath, HCkString outStr);
CK_VISIBLE_PUBLIC const char *CkFileAccess_fileSizeStr(HCkFileAccess cHandle, const char *filePath);
...
CK_VISIBLE_PUBLIC int CkFileAccess_ReadNextFragment(HCkFileAccess cHandle, BOOL startAtBeginning, const char *beginMarker, const char *endMarker, const char *charset, HCkStringBuilder sb);
...
CK_VISIBLE_PUBLIC BOOL CkFileAccess_Truncate(HCkFileAccess cHandle);
