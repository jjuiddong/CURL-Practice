...
CK_VISIBLE_PUBLIC BOOL CkTrustedRoots_getRejectSelfSignedCerts(HCkTrustedRoots cHandle);
CK_VISIBLE_PUBLIC void CkTrustedRoots_putRejectSelfSignedCerts(HCkTrustedRoots cHandle, BOOL newVal);
