...
CK_VISIBLE_PUBLIC void CkRestW_getUncommonOptions(HCkRestW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void  CkRestW_putUncommonOptions(HCkRestW cHandle, const wchar_t *newVal);
CK_VISIBLE_PUBLIC const wchar_t *CkRestW_uncommonOptions(HCkRestW cHandle);
