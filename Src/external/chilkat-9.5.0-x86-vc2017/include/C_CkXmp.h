...
CK_VISIBLE_PUBLIC void CkXmp_getUncommonOptions(HCkXmp cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void CkXmp_putUncommonOptions(HCkXmp cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkXmp_uncommonOptions(HCkXmp cHandle);
