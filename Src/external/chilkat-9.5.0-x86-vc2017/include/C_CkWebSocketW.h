...
CK_VISIBLE_PUBLIC void CkWebSocketW_getUncommonOptions(HCkWebSocketW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkWebSocketW_uncommonOptions(HCkWebSocketW cHandle);
