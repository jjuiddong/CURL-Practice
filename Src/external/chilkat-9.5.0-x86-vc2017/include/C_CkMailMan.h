...
CK_VISIBLE_PUBLIC void CkMailMan_getUncommonOptions(HCkMailMan cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void CkMailMan_putUncommonOptions(HCkMailMan cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkMailMan_uncommonOptions(HCkMailMan cHandle);
