...
CK_VISIBLE_PUBLIC BOOL CkTrustedRootsW_getRejectSelfSignedCerts(HCkTrustedRootsW cHandle);
CK_VISIBLE_PUBLIC void  CkTrustedRootsW_putRejectSelfSignedCerts(HCkTrustedRootsW cHandle, BOOL newVal);
