...
CK_VISIBLE_PUBLIC BOOL CkBinDataW_AppendPadded(HCkBinDataW cHandle, const wchar_t *str, const wchar_t *charset, BOOL padWithSpace, int fieldLen);
...
CK_VISIBLE_PUBLIC const unsigned char *CkBinDataW_GetBytesPtr(HCkBinDataW cHandle);
