...
CK_VISIBLE_PUBLIC BOOL CkBinData_AppendPadded(HCkBinData cHandle, const char *str, const char *charset, BOOL padWithSpace, int fieldLen);
...
CK_VISIBLE_PUBLIC const unsigned char *CkBinData_GetBytesPtr(HCkBinData cHandle);
