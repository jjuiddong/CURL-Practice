...
CK_VISIBLE_PUBLIC void CkStringBuilderW_Obfuscate(HCkStringBuilderW cHandle);
...
CK_VISIBLE_PUBLIC void CkStringBuilderW_Unobfuscate(HCkStringBuilderW cHandle);
