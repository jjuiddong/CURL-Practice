...
CK_VISIBLE_PUBLIC void CkRest_getUncommonOptions(HCkRest cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void CkRest_putUncommonOptions(HCkRest cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkRest_uncommonOptions(HCkRest cHandle);
