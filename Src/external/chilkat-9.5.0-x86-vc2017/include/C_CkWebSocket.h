...
CK_VISIBLE_PUBLIC void CkWebSocket_getUncommonOptions(HCkWebSocket cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkWebSocket_uncommonOptions(HCkWebSocket cHandle);
