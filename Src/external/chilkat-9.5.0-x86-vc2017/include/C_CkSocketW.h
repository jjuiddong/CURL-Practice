...
CK_VISIBLE_PUBLIC void CkSocketW_getUncommonOptions(HCkSocketW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void  CkSocketW_putUncommonOptions(HCkSocketW cHandle, const wchar_t *newVal);
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_uncommonOptions(HCkSocketW cHandle);
