// This is a generated source file for Chilkat version 9.5.0.80
#ifndef _C_CkXmpWH
#define _C_CkXmpWH
...
CK_VISIBLE_PUBLIC void CkXmpW_getUncommonOptions(HCkXmpW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void  CkXmpW_putUncommonOptions(HCkXmpW cHandle, const wchar_t *newVal);
CK_VISIBLE_PUBLIC const wchar_t *CkXmpW_uncommonOptions(HCkXmpW cHandle);
