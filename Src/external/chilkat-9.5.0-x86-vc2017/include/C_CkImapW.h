...
CK_VISIBLE_PUBLIC void CkImapW_getUncommonOptions(HCkImapW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void  CkImapW_putUncommonOptions(HCkImapW cHandle, const wchar_t *newVal);
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_uncommonOptions(HCkImapW cHandle);
