...
CK_VISIBLE_PUBLIC void CkImap_getUncommonOptions(HCkImap cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void CkImap_putUncommonOptions(HCkImap cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkImap_uncommonOptions(HCkImap cHandle);
