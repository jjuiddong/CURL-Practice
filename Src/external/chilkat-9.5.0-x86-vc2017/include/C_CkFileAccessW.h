...
CK_VISIBLE_PUBLIC BOOL CkFileAccessW_getLockFileOnOpen(HCkFileAccessW cHandle);
CK_VISIBLE_PUBLIC void  CkFileAccessW_putLockFileOnOpen(HCkFileAccessW cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkFileAccessW_FileSizeStr(HCkFileAccessW cHandle, const wchar_t *filePath, HCkString outStr);
CK_VISIBLE_PUBLIC const wchar_t *CkFileAccessW_fileSizeStr(HCkFileAccessW cHandle, const wchar_t *filePath);
...
CK_VISIBLE_PUBLIC int CkFileAccessW_ReadNextFragment(HCkFileAccessW cHandle, BOOL startAtBeginning, const wchar_t *beginMarker, const wchar_t *endMarker, const wchar_t *charset, HCkStringBuilderW sb);
...
CK_VISIBLE_PUBLIC BOOL CkFileAccessW_Truncate(HCkFileAccessW cHandle);
